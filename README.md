...
`PURESLOP.md` is a markdown file consumed by AI coding agents. It contains concrete directives that instruct the agent to produce code full of slop. The agent reads it and follows the directives like any other instruction file.

It is language-agnostic and agent-agnostic.
...
That's it. Your agent will now produce pure, unadulterated slop.

![Finally Pure Slop!](https://github.com/user-attachments/assets/e2632db4-b011-452e-bdf1-ad2483ee3d7e)
